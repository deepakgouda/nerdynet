...
*Image 1: AFRINIC and RIPE IPv4 delegation hierarchy (simplified)*
{: .table-caption}
...
*Image 1: RIPE IPv6 delegation hierarchy (simplified)*
{: .table-caption}
...
*Table 4: Delegation types and usage terms in AFRINIC and RIPE*
{: .table-caption}
